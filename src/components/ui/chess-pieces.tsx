...
interface PieceProps extends SVGProps<SVGSVGElement> {
  size?: number;
}

export const ChessKing: FC<PieceProps> = ({ size = 48, ...props }) => (
  <svg viewBox="0 0 45 45" width={size} height={size} fill="none" {...props}>
    <g fill="currentColor" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M22.5 25s4.5-7.5 3-10.5c0 0-1-2.5-3-2.5s-3 2.5-3 2.5c-1.5 3 3 10.5 3 10.5" fill="currentColor" stroke="currentColor" />
      <path d="M12.5 37c5.5 3.5 14.5 3.5 20 0v-7s9-4.5 6-10.5c-4-6.5-13.5-3.5-16 4V27v-3.5c-2.5-7.5-12-10.5-16-4-3 6 6 10.5 6 10.5v7" fill="currentColor" stroke="currentColor" />
      <path d="M12.5 30c5.5-3 14.5-3 20 0M12.5 33.5c5.5-3 14.5-3 20 0M12.5 37c5.5-3 14.5-3 20 0" stroke="rgba(0,0,0,0.3)" strokeWidth="1" fill="none" />
    </g>
  </svg>
);
...
export const ChessBishop: FC<PieceProps> = ({ size = 48, ...props }) => (
  <svg viewBox="0 0 45 45" width={size} height={size} fill="none" {...props}>
    <g fill="currentColor" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M9 36c3.39-.97 10.11.43 13.5-2 3.39 2.43 10.11 1.03 13.5 2 0 0 1.65.54 3 2-.68.97-1.65.99-3 .5-3.39-.97-10.11.46-13.5-1-3.39 1.46-10.11.03-13.5 1-1.354.49-2.323.47-3-.5 1.354-1.94 3-2 3-2z" />
      <path d="M15 32c2.5 2.5 12.5 2.5 15 0 .5-1.5 0-2 0-2 0-2.5-2.5-4-2.5-4 5.5-1.5 6-11.5-5-15.5-11 4-10.5 14-5 15.5 0 0-2.5 1.5-2.5 4 0 0-.5.5 0 2z" />
      <circle cx="22.5" cy="8" r="2.5" />
      <path d="M17.5 26h10M15 30h15" stroke="rgba(0,0,0,0.3)" strokeWidth="1" fill="none" />
    </g>
  </svg>
);
