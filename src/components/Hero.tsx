    ...
    <section id="hero" className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 z-10 flex flex-col justify-center items-center text-center px-6">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-serif font-bold text-gradient-heading leading-tight">
            {personalInfo.name}
          </h1>
          ...
          <div className="mt-8 flex flex-wrap gap-4 justify-center">
            <a
              href="#projects"
              className="px-6 py-3 bg-white text-background font-semibold rounded-lg hover:bg-accent-muted transition-colors"
            >
              View My Moves
            </a>
            <a
              ...
              className="px-6 py-3 border border-border text-foreground rounded-lg hover:border-accent-muted hover:text-white transition-colors flex items-center gap-2"
            >
              <Github size={18} />
              GitHub
            </a>
